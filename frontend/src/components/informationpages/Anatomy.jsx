...
import NervousImage from "../../assets/Nervous_System_vs_Endocrine_System_outline.jpg";
import Homeostasis from "../../assets/homeostasis-2.webp";
    ...
    return (
        <div className="Anatomy-container">
            ...
            <div className="Anatomy-card">
                ...
                <h2>The Nervous & Endocrine Systems</h2><br></br>
                <img src={NervousImage} alt="Image showing nervous system and endocrine system"  height={400} width={550}/> <br></br>
                <h4>
                ...
                <h4>
                    The nervous system uses quick electrical impulses and neurotransmitters to send messages. It's made up of neurons which are the building blocks of the body's communication system. They create a network that allows signals to move between the brain and body.
                ...
                <h4>
                    ...
                    Your body’s circulatory system consists of your heart and blood vessels.
                </h4>
                ...
                <h2>Homeostasis</h2><br></br>
                <img src={Homeostasis} alt="Diagram showing homeostasis" height={400} width={650} /> <br></br>
                <h4>
                ...
                <h4>
                     Unlike the negative feedback loop, positive feedback loops amplify a stimulus. Blood clotting, immune responses, and labor/delivery are examples where the process builds upon itself.
                </h4><br></br>
                <h4>
